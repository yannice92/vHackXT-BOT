...
public class FragmentActivity extends Activity
{
    ...
    final s mContainer = new q(this);
    boolean mCreated;
    final u mFragments = new u();
    final Handler mHandler = new p(this);
    an mLoaderManager;
...
_L9:
    ...
    public void dump(String s, FileDescriptor filedescriptor, PrintWriter printwriter, String as[])
    {
        ...
        if (mLoaderManager != null)
        {
            ...
            printwriter.println(":");
            mLoaderManager.a((new StringBuilder()).append(s).append("  ").toString(), printwriter);
        }
    ...
    {
        r r1 = (r)getLastNonConfigurationInstance();
        if (r1 != null)
        {
            return r1.b;
        } else
    ...
    an getLoaderManager(String s, boolean flag, boolean flag1)
    {
        if (mAllLoaderManagers == null)
        {
            mAllLoaderManagers = new m();
        }
        an an1 = (an)mAllLoaderManagers.get(s);
        if (an1 == null)
        {
            if (flag1)
            {
                an1 = new an(s, this, flag);
                mAllLoaderManagers.put(s, an1);
            }
            return an1;
        } else
        {
    ...
    public al getSupportLoaderManager()
    {
        if (mLoaderManager != null)
        {
    ...
    protected void onActivityResult(int i, int j, Intent intent)
    {
        ...
        {
            j = k - 1;
            if (mFragments.f == null || j < 0 || j >= mFragments.f.size())
            {
            ...
            if ((Fragment)mFragments.f.get(j) == null)
            {
...
_L3:
    ...
    public final Object onRetainNonConfigurationInstance()
    {
        ...
        ArrayList arraylist = mFragments.e();
        boolean flag1;
        if (mAllLoaderManagers != null)
        {
            ...
            for (int i = k - 1; i >= 0; i--)
            {
                aan[i] = (an)mAllLoaderManagers.c(i);
            }
            ...
            do
            {
                ...
                {
                    an1.h();
                    mAllLoaderManagers.remove(an1.d);
                }
                j++;
            } while (true);
        } else
    ...
    public void setEnterSharedElementCallback(cn cn)
    {
        a.a(this, cn);
    }

    public void setExitSharedElementCallback(cn cn)
    {
        a.b(this, cn);
    }
    ...
    public void startActivityFromFragment(Fragment fragment, Intent intent, int i)
    {
        ...
        {
            super.startActivityForResult(intent, (fragment.g + 1 << 16) + (0xffff & i));
            return;
        }
    }

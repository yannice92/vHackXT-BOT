    ...
    implements au, av
{
    ...
    public cb(Context context, Notification notification, CharSequence charsequence, CharSequence charsequence1, CharSequence charsequence2, RemoteViews remoteviews, int i, 
    ...
    {
        android.util.SparseArray sparsearray = by.a(c);
        if (sparsearray != null)
        {

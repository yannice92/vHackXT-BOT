...
public final class bn
{
    ...
    private static final Interpolator v = new android.support.v4.widget.bo();
    private int a;
    private int b;
    private int c;
    private float d[];
    ...
    private final Runnable w = new bp(this);

    private bn(Context context, ViewGroup viewgroup, bq bq1)
    {
        c = -1;
        if (viewgroup == null)
        {
    ...
    public static bn a(ViewGroup viewgroup, float f1, bq bq1)
    {
        viewgroup = new bn(viewgroup.getContext(), viewgroup, bq1);
        viewgroup.b = (int)((float)((bn) (viewgroup)).b * (1.0F / f1));
        return viewgroup;
    }
    ...
    private boolean a(int i1, int j1, int k1, int l1)
    {
        ...
        obj = q;
        ((ar) (obj)).b.a(((ar) (obj)).a, i2, j2, i1, j1, k1);
        b(2);
        return true;
    }
    ...
    public final boolean a(int i1, int j1)
    {
        ...
        {
            return a(i1, j1, (int)bo.a(l, c), (int)bo.b(l, c));
        }
    }

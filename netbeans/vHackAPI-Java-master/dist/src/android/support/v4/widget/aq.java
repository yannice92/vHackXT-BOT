...
public abstract class aq extends h
{
    ...
    public aq(Context context, int i, Cursor cursor)
    {
    ...
    public aq(Context context, int i, Cursor cursor, int j)
    {
    ...
    public aq(Context context, int i, Cursor cursor, boolean flag)
    {

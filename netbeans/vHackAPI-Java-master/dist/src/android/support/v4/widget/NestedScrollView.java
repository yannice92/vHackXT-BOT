    ...
    implements az, bb
{
    ...
    private void a(MotionEvent motionevent)
    {
        ...
        if (at.b(motionevent, i1) == q)
        {
            ...
            f = (int)at.d(motionevent, i1);
            q = at.b(motionevent, i1);
            if (k != null)
            {
                k.clear();
            }
...
_L10:
    ...
    {
        if ((at.d(motionevent) & 2) == 0) goto _L2; else goto _L1
_L1:
...
_L8:
        d.a((float)i1 / (float)getHeight(), at.c(motionevent, i2) / (float)getWidth());
        if (!e.a())
        {
            e.c();
        }
...
_L9:
        if (l1 > j2)
        {
            e.a((float)i1 / (float)getHeight(), 1.0F - at.c(motionevent, i2) / (float)getWidth());
            if (!d.a())
            {
                d.c();
            }
...
_L5:
        ...
        continue; /* Loop/switch isn't completed */
_L6:
        int k1 = at.b(motionevent);
        f = (int)at.d(motionevent, k1);
        q = at.b(motionevent, k1);
        continue; /* Loop/switch isn't completed */
_L7:
        a(motionevent);
        f = (int)at.d(motionevent, at.a(motionevent, q));

    ...
    implements android.support.v7.internal.widget.ActionBarOverlayLayout.ActionBarVisibilityCallback
{
    ...
    public void doHide(boolean flag)
    {
        ...
        if (mCurWindowVisibility == 0 && ALLOW_SHOW_HIDE_ANIMATIONS && (mShowHideAnimationEnabled || flag))
        {
            ...
            do do1 = bs.l(mContainerView).c(f);
            do1.a(mUpdateListener);
            viewpropertyanimatorcompatset.play(do1);
            if (mContentAnimations && mContentView != null)
            {
                viewpropertyanimatorcompatset.play(bs.l(mContentView).c(f));
            }
            if (mSplitView != null && mSplitView.getVisibility() == 0)
            {
                bs.c(mSplitView, 1.0F);
                viewpropertyanimatorcompatset.play(bs.l(mSplitView).c(mSplitView.getHeight()));
            }
    ...
    public void doShow(boolean flag)
    {
        ...
        if (mCurWindowVisibility == 0 && ALLOW_SHOW_HIDE_ANIMATIONS && (mShowHideAnimationEnabled || flag))
        {
            ...
            bs.b(mContainerView, f);
            ViewPropertyAnimatorCompatSet viewpropertyanimatorcompatset = new ViewPropertyAnimatorCompatSet();
            do do1 = bs.l(mContainerView).c(0.0F);
            do1.a(mUpdateListener);
            viewpropertyanimatorcompatset.play(do1);
            if (mContentAnimations && mContentView != null)
            {
                bs.b(mContentView, f);
                viewpropertyanimatorcompatset.play(bs.l(mContentView).c(0.0F));
            }
            if (mSplitView != null && mContextDisplayMode == 1)
            {
                bs.b(mSplitView, mSplitView.getHeight());
                mSplitView.setVisibility(0);
                viewpropertyanimatorcompatset.play(bs.l(mSplitView).c(0.0F));
            }
        ...
        } else
        {
            ...
            if (mContentAnimations && mContentView != null)
            {
                bs.b(mContentView, 0.0F);
            }
            if (mSplitView != null && mContextDisplayMode == 1)
            {
                bs.c(mSplitView, 1.0F);
                bs.b(mSplitView, 0.0F);
                mSplitView.setVisibility(0);
            }
...
_L2:
        ...
        {
            ad1 = ((FragmentActivity)mActivity).getSupportFragmentManager().a().a();
        } else
        {
            ad1 = null;
        }
        ...
        if (mSelectedTab != null)
        {
            mSelectedTab.getCallback().onTabReselected(mSelectedTab, ad1);
...
_L3:
        ...
        if (mSelectedTab != null)
        {
            mSelectedTab.getCallback().onTabUnselected(mSelectedTab, ad1);
        }
        mSelectedTab = (TabImpl)tab;
        if (mSelectedTab != null)
        {
            mSelectedTab.getCallback().onTabSelected(mSelectedTab, ad1);
        }
          goto _L5

...
_L3:
    ...
    private class MenuState
    {
        ...
        private void setItem(MenuItem menuitem)
        {
            ...
            {
                an.a(menuitem, itemShowAsAction);
            }
            ...
            {
                an.a(menuitem, (View)newInstance(itemActionViewClassName, SupportMenuInflater.ACTION_VIEW_CONSTRUCTOR_SIGNATURE, mActionViewConstructorArguments));
            } else
            {
                flag = false;
            }
            if (itemActionViewLayout > 0)
            {
                if (!flag)
                {
                    an.b(menuitem, itemActionViewLayout);
                } else
                {
            ...
            {
                an.a(menuitem, itemActionProvider);
            }
        }
        ...
        public void readItem(AttributeSet attributeset)
        {
            ...
            {
                itemActionProvider = (n)newInstance(itemActionProviderClassName, SupportMenuInflater.ACTION_PROVIDER_CONSTRUCTOR_SIGNATURE, mActionProviderConstructorArguments);
            } else
            {
                if (i != 0)
                {

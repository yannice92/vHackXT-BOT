...
public class ActionBarOverlayLayout extends ViewGroup
    implements bb, DecorContentParent
{
    ...
    private final ee mBottomAnimatorListener;
    private ContentFrameLayout mContent;
    private final Rect mContentInsets;
    private do mCurrentActionBarBottomAnimator;
    private do mCurrentActionBarTopAnimator;
    private DecorToolbar mDecorToolbar;
    private ar mFlingEstimator;
    ...
    private final bc mParentHelper;
    private final Runnable mRemoveActionBarHideOffset;
    private final ee mTopAnimatorListener;
    ...
    private void haltActionBarHideOffsetAnimations()
    {
        ...
        {
            mCurrentActionBarBottomAnimator.b();
        }
    }
    ...
    {
        mFlingEstimator.a((int)f1);
        return mFlingEstimator.d() > mActionBarTop.getHeight();
    }
    ...
    public void draw(Canvas canvas)
    {
        ...
        if (mWindowContentOverlay != null && !mIgnoreWindowContentOverlay)
        {
            ...
            {
                i = (int)((float)mActionBarTop.getBottom() + bs.j(mActionBarTop) + 0.5F);
            } else
            {
                i = 0;
            }
    ...
    protected void onMeasure(int i, int j)
    {
        ...
        int i1 = ViewUtils.combineMeasuredStates(0, bs.i(mActionBarTop));
        if (mActionBarBottom != null)
        {
            ...
            i1 = ViewUtils.combineMeasuredStates(i1, bs.i(mActionBarBottom));
        }
        boolean flag;
        if ((bs.o(this) & 0x100) != 0)
        {
            flag = true;
        } else
        {
        ...
        i1 = ViewUtils.combineMeasuredStates(i1, bs.i(mContent));
        j1 = getPaddingLeft();
        k1 = getPaddingRight();
        l = Math.max(l + (getPaddingTop() + getPaddingBottom()), getSuggestedMinimumHeight());
        setMeasuredDimension(bs.a(Math.max(k + (j1 + k1), getSuggestedMinimumWidth()), i, i1), bs.a(l, j, i1 << 16));
    }
...
/*
    static do access$002(ActionBarOverlayLayout actionbaroverlaylayout, do do1)
    {
        actionbaroverlaylayout.mCurrentActionBarTopAnimator = do1;
        return do1;
    }
...
/*
    static do access$202(ActionBarOverlayLayout actionbaroverlaylayout, do do1)
    {
        actionbaroverlaylayout.mCurrentActionBarBottomAnimator = do1;
        return do1;
    }
...
*/
    ...
    private class _cls2 extends ef
    {
        ...
        implements Runnable
    {
        ...
        {
            haltActionBarHideOffsetAnimations();
            mCurrentActionBarTopAnimator = bs.l(mActionBarTop).c(0.0F).a(mTopAnimatorListener);
            if (mActionBarBottom != null && mActionBarBottom.getVisibility() != 8)
            {
                mCurrentActionBarBottomAnimator = bs.l(mActionBarBottom).c(0.0F).a(mBottomAnimatorListener);
            }
        }
        ...
        implements Runnable
    {
        ...
        {
            haltActionBarHideOffsetAnimations();
            mCurrentActionBarTopAnimator = bs.l(mActionBarTop).c(-mActionBarTop.getHeight()).a(mTopAnimatorListener);
            if (mActionBarBottom != null && mActionBarBottom.getVisibility() != 8)
            {
                mCurrentActionBarBottomAnimator = bs.l(mActionBarBottom).c(mActionBarBottom.getHeight()).a(mBottomAnimatorListener);
            }
        }

    ...
    implements ActivityChooserModel.ActivityChooserModelClient
{
    ...
    public ActivityChooserView(Context context, AttributeSet attributeset, int i)
    {
        ...
        ((FrameLayout) (obj)).setOnTouchListener(new _cls3(((View) (obj))));
        ...
        mAdapter.registerDataSetObserver(new _cls4());
...
_L6:
    ...
    private class _cls3 extends android.support.v7.widget.ListPopupWindow.ForwardingListener
    {
...
_L9:
    ...
    private class _cls4 extends DataSetObserver
    {

...
label0:
    ...
    {
        bs.a(mClose, -mClose.getWidth() - ((android.view.ViewGroup.MarginLayoutParams)mClose.getLayoutParams()).leftMargin);
        do do1 = bs.l(mClose).b(0.0F);
        do1.a(200L);
        do1.a(this);
        do1.a(new DecelerateInterpolator());
        ...
        if (mMenuView != null)
        {
            ...
            if (i > 0)
            {
                for (i--; i >= 0; i--)
                {
                    ...
                    obj = bs.l(((View) (obj))).a();
                    ((do) (obj)).a(300L);
                    viewpropertyanimatorcompatset.play(((do) (obj)));
                }
    ...
    {
        do do1 = bs.l(mClose).b(-mClose.getWidth() - ((android.view.ViewGroup.MarginLayoutParams)mClose.getLayoutParams()).leftMargin);
        do1.a(200L);
        do1.a(this);
        do1.a(new DecelerateInterpolator());
        ViewPropertyAnimatorCompatSet viewpropertyanimatorcompatset = new ViewPropertyAnimatorCompatSet();

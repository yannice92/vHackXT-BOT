...
_L7:
    ...
    public void drawableHotspotChanged(float f, float f1)
    {
        ...
        if (mThumbDrawable != null)
        {
            a.a(mThumbDrawable, f, f1);
        }
        if (mTrackDrawable != null)
        {
            a.a(mTrackDrawable, f, f1);
        }
    }
...
_L4:
    ...
    public void onMeasure(int i, int j)
    {
        ...
        i1 = Math.max(mSwitchMinWidth, j1 + mThumbWidth * 2 + i1);
        k = Math.max(l, k);
        mSwitchWidth = i1;
        mSwitchHeight = k;
        super.onMeasure(i, j);
        ...
        {
            setMeasuredDimension(bs.h(this), k);
        }
    }
...
_L5:
    ...
    public void setChecked(boolean flag)
    {
        ...
        flag = isChecked();
        if (getWindowToken() != null && bs.u(this))
        {

...
_L4:
        ...
        i1 = ViewUtils.combineMeasuredStates(i1, bs.i(view1));
        if (flag2)
        {
...
_L2:
        ...
        k5 = bs.a(Math.max(mTotalLength, getSuggestedMinimumWidth()), i, 0);
            ...
            while (i2 < j6) 
            {
                ...
                if (view3 != null && view3.getVisibility() != 8)
                {
                    ...
                    if (f1 > 0.0F)
                    {
                        ...
                        k = ViewUtils.combineMeasuredStates(k, bs.i(view3) & 0xff000000);
                        f -= f1;
                        l1 = k1 - k2;
                        k1 = k;
                        k = l1;
...
_L9:
        ...
        setMeasuredDimension(0xff000000 & l | k5, bs.a(Math.max(k + (getPaddingTop() + getPaddingBottom()), getSuggestedMinimumHeight()), j, l << 16));
        if (flag)
        {
...
_L8:
        ...
        i1 = Math.max(i1, k5);
        i2 = ViewUtils.combineMeasuredStates(l, bs.i(view));
...
_L2:
        ...
        int k4 = bs.a(Math.max(mTotalLength, getSuggestedMinimumHeight()), j, 0);
            ...
            while (i2 < l5) 
            {
                ...
                if (view2.getVisibility() != 8)
                {
                    ...
                    if (f1 > 0.0F)
                    {
                        ...
                        k = ViewUtils.combineMeasuredStates(k, bs.i(view2) & 0xffffff00);
                        l1 = k1 - j2;
                        k1 = k;
                        f -= f1;
                        k = l1;
        ...
        setMeasuredDimension(bs.a(Math.max(k + (getPaddingLeft() + getPaddingRight()), getSuggestedMinimumWidth()), i, j1), k4);
        if (flag)
        {

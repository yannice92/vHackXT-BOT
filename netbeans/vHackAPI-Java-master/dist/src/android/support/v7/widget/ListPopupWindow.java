...
public class ListPopupWindow
{
    ...
    public ListPopupWindow(Context context, AttributeSet attributeset, int i, int j)
    {
        ...
        mLayoutDirection = f.a(mContext.getResources().getConfiguration().locale);
    }
...
_L3:
    ...
    private class DropDownListView extends ListViewCompat
    {
        ...
        private do mClickAnimation;
        private boolean mDrawsInPressedState;
        private boolean mHijackFocus;
        private boolean mListSelectionHidden;
        private ae mScrollHelper;
        ...
        private void setPressedItem(View view, int i, float f1, float f2)
        {
            mDrawsInPressedState = true;
            setPressed(true);
            layoutChildren();
            setSelection(i);
            positionSelectorLikeTouchCompat(i, view, f1, f2);
...
_L3:
            ...
            private static boolean pointInView(View view, float f1, float f2, float f3)
            {

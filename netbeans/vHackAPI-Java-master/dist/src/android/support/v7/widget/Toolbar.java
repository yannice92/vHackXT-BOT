...
_L11:
    ...
    protected void onMeasure(int i, int j)
    {
        ...
        if (shouldLayout(mNavButtonView))
        {
            ...
            i1 = ViewUtils.combineMeasuredStates(0, bs.i(mNavButtonView));
        } else
        {
            i1 = 0;
            j1 = 0;
        ...
        if (shouldLayout(mCollapseButtonView))
        {
            ...
            k = ViewUtils.combineMeasuredStates(i1, bs.i(mCollapseButtonView));
        }
        ...
        if (shouldLayout(mMenuView))
        {
            ...
            i1 = ViewUtils.combineMeasuredStates(k, bs.i(mMenuView));
        }
        ...
        if (shouldLayout(mExpandedActionView))
        {
            ...
            k = ViewUtils.combineMeasuredStates(i1, bs.i(mExpandedActionView));
        }
        i1 = l1;
        j1 = k;
        k1 = l;
        if (shouldLayout(mLogoView))
        {
            ...
            j1 = ViewUtils.combineMeasuredStates(k, bs.i(mLogoView));
        }
        i2 = getChildCount();
        l1 = 0;
        l = k1;
        ...
        while (j1 < i2) 
        {
            ...
            if (((LayoutParams)view.getLayoutParams()).mViewType == 0 && shouldLayout(view))
            {
                ...
                l = ViewUtils.combineMeasuredStates(k, bs.i(view));
                k = i1;
            } else
            {
                i1 = l;
        ...
        if (shouldLayout(mTitleTextView))
        {
            ...
            i1 = ViewUtils.combineMeasuredStates(k, bs.i(mTitleTextView));
        }
        l2 = j1;
        j2 = k1;
        k = i1;
        if (shouldLayout(mSubtitleTextView))
        {
            ...
            k = ViewUtils.combineMeasuredStates(i1, bs.i(mSubtitleTextView));
        }
        l = Math.max(l, l2);
        k1 = getPaddingLeft();
        l2 = getPaddingRight();
        i1 = getPaddingTop();
        j1 = getPaddingBottom();
        k1 = bs.a(Math.max(j2 + l1 + (k1 + l2), getSuggestedMinimumWidth()), i, 0xff000000 & k);
        i = bs.a(Math.max(l + (i1 + j1), getSuggestedMinimumHeight()), j, k << 16);
        if (shouldCollapse())
        {
            i = 0;
        }

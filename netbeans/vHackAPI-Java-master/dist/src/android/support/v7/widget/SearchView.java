...
_L6:
    ...
    {
        if (mSearchable != null && mSuggestionsAdapter != null && keyevent.getAction() == 0 && u.b(keyevent))
        {
            if (i == 66 || i == 84 || i == 61)
            {
...
_L5:
    ...
    public void setSuggestionsAdapter(h h1)
    {
        mSuggestionsAdapter = h1;
        mSearchSrcTextView.setAdapter(mSuggestionsAdapter);
    }
        ...
        implements android.view.View.OnKeyListener
    {
        ...
        public boolean onKey(View view, int i, KeyEvent keyevent)
        {
            if (mSearchable != null)
            {
                ...
                if (!mSearchSrcTextView.isEmpty() && u.b(keyevent) && keyevent.getAction() == 1 && i == 66)
                {

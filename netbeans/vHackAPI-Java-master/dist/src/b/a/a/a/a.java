    ...
    implements b.a.a.a
{
    ...
    private void a(int ai[][])
    {
        ...
        for (i1 = 1; i1 < f - 1;)
        {
            int l2 = d[h & 0xff] ^ a(d[i >> 8 & 0xff], 24) ^ a(d[j >> 16 & 0xff], 16) ^ a(d[k >> 24 & 0xff], 8) ^ ai[i1][0];
            int j2 = d[i & 0xff] ^ a(d[j >> 8 & 0xff], 24) ^ a(d[k >> 16 & 0xff], 16) ^ a(d[h >> 24 & 0xff], 8) ^ ai[i1][1];
            int l1 = d[j & 0xff] ^ a(d[k >> 8 & 0xff], 24) ^ a(d[h >> 16 & 0xff], 16) ^ a(d[i >> 24 & 0xff], 8) ^ ai[i1][2];
            int j3 = d[k & 0xff];
            int l3 = a(d[h >> 8 & 0xff], 24);
            int j4 = a(d[i >> 16 & 0xff], 16);
            int l4 = a(d[j >> 24 & 0xff], 8);
            int j1 = i1 + 1;
            i1 = ai[i1][3] ^ (j3 ^ l3 ^ j4 ^ l4);
            h = d[l2 & 0xff] ^ a(d[j2 >> 8 & 0xff], 24) ^ a(d[l1 >> 16 & 0xff], 16) ^ a(d[i1 >> 24 & 0xff], 8) ^ ai[j1][0];
            i = d[j2 & 0xff] ^ a(d[l1 >> 8 & 0xff], 24) ^ a(d[i1 >> 16 & 0xff], 16) ^ a(d[l2 >> 24 & 0xff], 8) ^ ai[j1][1];
            j = d[l1 & 0xff] ^ a(d[i1 >> 8 & 0xff], 24) ^ a(d[l2 >> 16 & 0xff], 16) ^ a(d[j2 >> 24 & 0xff], 8) ^ ai[j1][2];
            j3 = d[i1 & 0xff];
            l2 = a(d[l2 >> 8 & 0xff], 24);
            j2 = a(d[j2 >> 16 & 0xff], 16);
            l1 = a(d[l1 >> 24 & 0xff], 8);
            i1 = j1 + 1;
            k = l1 ^ (j3 ^ l2 ^ j2) ^ ai[j1][3];
        }

        int k1 = d[h & 0xff] ^ a(d[i >> 8 & 0xff], 24) ^ a(d[j >> 16 & 0xff], 16) ^ a(d[k >> 24 & 0xff], 8) ^ ai[i1][0];
        int i2 = d[i & 0xff] ^ a(d[j >> 8 & 0xff], 24) ^ a(d[k >> 16 & 0xff], 16) ^ a(d[h >> 24 & 0xff], 8) ^ ai[i1][1];
        int k2 = d[j & 0xff] ^ a(d[k >> 8 & 0xff], 24) ^ a(d[h >> 16 & 0xff], 16) ^ a(d[i >> 24 & 0xff], 8) ^ ai[i1][2];
        int k3 = d[k & 0xff];
        int i4 = a(d[h >> 8 & 0xff], 24);
        int k4 = a(d[i >> 16 & 0xff], 16);
        int i5 = a(d[j >> 24 & 0xff], 8);
        int i3 = i1 + 1;
    ...
    private void b(int ai[][])
    {
        ...
        for (i1 = f - 1; i1 > 1;)
        {
            int l1 = e[h & 0xff] ^ a(e[k >> 8 & 0xff], 24) ^ a(e[j >> 16 & 0xff], 16) ^ a(e[i >> 24 & 0xff], 8) ^ ai[i1][0];
            int j2 = e[i & 0xff] ^ a(e[h >> 8 & 0xff], 24) ^ a(e[k >> 16 & 0xff], 16) ^ a(e[j >> 24 & 0xff], 8) ^ ai[i1][1];
            int l2 = e[j & 0xff] ^ a(e[i >> 8 & 0xff], 24) ^ a(e[h >> 16 & 0xff], 16) ^ a(e[k >> 24 & 0xff], 8) ^ ai[i1][2];
            int j3 = e[k & 0xff];
            int l3 = a(e[j >> 8 & 0xff], 24);
            int j4 = a(e[i >> 16 & 0xff], 16);
            int l4 = a(e[h >> 24 & 0xff], 8);
            int j1 = i1 - 1;
            i1 = ai[i1][3] ^ (j3 ^ l3 ^ j4 ^ l4);
            h = e[l1 & 0xff] ^ a(e[i1 >> 8 & 0xff], 24) ^ a(e[l2 >> 16 & 0xff], 16) ^ a(e[j2 >> 24 & 0xff], 8) ^ ai[j1][0];
            i = e[j2 & 0xff] ^ a(e[l1 >> 8 & 0xff], 24) ^ a(e[i1 >> 16 & 0xff], 16) ^ a(e[l2 >> 24 & 0xff], 8) ^ ai[j1][1];
            j = e[l2 & 0xff] ^ a(e[j2 >> 8 & 0xff], 24) ^ a(e[l1 >> 16 & 0xff], 16) ^ a(e[i1 >> 24 & 0xff], 8) ^ ai[j1][2];
            j3 = e[i1 & 0xff];
            l2 = a(e[l2 >> 8 & 0xff], 24);
            j2 = a(e[j2 >> 16 & 0xff], 16);
            l1 = a(e[l1 >> 24 & 0xff], 8);
            i1 = j1 - 1;
            k = l1 ^ (j3 ^ l2 ^ j2) ^ ai[j1][3];
        }

        int k1 = e[h & 0xff] ^ a(e[k >> 8 & 0xff], 24) ^ a(e[j >> 16 & 0xff], 16) ^ a(e[i >> 24 & 0xff], 8) ^ ai[i1][0];
        int i2 = e[i & 0xff] ^ a(e[h >> 8 & 0xff], 24) ^ a(e[k >> 16 & 0xff], 16) ^ a(e[j >> 24 & 0xff], 8) ^ ai[i1][1];
        int k2 = e[j & 0xff] ^ a(e[i >> 8 & 0xff], 24) ^ a(e[h >> 16 & 0xff], 16) ^ a(e[k >> 24 & 0xff], 8) ^ ai[i1][2];
        int i3 = e[k & 0xff];
        int k3 = a(e[j >> 8 & 0xff], 24);
        int i4 = a(e[i >> 16 & 0xff], 16);
        int k4 = a(e[h >> 24 & 0xff], 8);
    ...
    {
        if (c1 instanceof b.a.a.d.a)
        {
            byte abyte0[] = ((b.a.a.d.a)c1).a();
            ...
            f = k2 + 6;
            int i1 = f;
            c1 = (int[][])Array.newInstance(Integer.TYPE, new int[] {
                i1 + 1, 4
            });
            int i2 = 0;
            for (int j1 = 0; i2 < abyte0.length; j1++)
            {
                c1[j1 >> 2][j1 & 3] = abyte0[i2] & 0xff | (abyte0[i2 + 1] & 0xff) << 8 | (abyte0[i2 + 2] & 0xff) << 16 | abyte0[i2 + 3] << 24;
                i2 += 4;
            }
            ...
            while (i2 < k3 + 1 << 2) 
            {
                int i3 = c1[i2 - 1 >> 2][i2 - 1 & 3];
                int k1;
                if (i2 % k2 == 0)
                {
                    k1 = b(a(i3, 8)) ^ c[i2 / k2 - 1];
                } else
                {
                    k1 = i3;
                    if (k2 > 6)
                ...
                c1[i2 >> 2][i2 & 3] = k1 ^ c1[i2 - k2 >> 2][i2 - k2 & 3];
                i2++;
            }
            if (!flag)
            {
        ...
        {
            throw new IllegalArgumentException((new StringBuilder("invalid parameter passed to AES init - ")).append(c1.getClass().getName()).toString());
        }
    }

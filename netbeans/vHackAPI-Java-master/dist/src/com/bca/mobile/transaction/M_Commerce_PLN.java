...
public class M_Commerce_PLN extends ShareActivity
    implements c, i
{
    ...
    static TextView a(M_Commerce_PLN m_commerce_pln)
    {
        return m_commerce_pln.an;
    }

    static void a(M_Commerce_PLN m_commerce_pln, int i1)
    {
        m_commerce_pln.M = i1;
    }

    static void a(M_Commerce_PLN m_commerce_pln, long l1)
    {
        m_commerce_pln.N = l1;
    }

    static void a(M_Commerce_PLN m_commerce_pln, Integer integer)
    {
        m_commerce_pln.Z = integer;
    }

    static void a(M_Commerce_PLN m_commerce_pln, String s)
    {
        m_commerce_pln.X = s;
    }

    static void a(M_Commerce_PLN m_commerce_pln, ArrayList arraylist)
    {
        m_commerce_pln.n = arraylist;
    }

    static void a(M_Commerce_PLN m_commerce_pln, boolean flag)
    {
        m_commerce_pln.K = flag;
    }

    static ArrayList b(M_Commerce_PLN m_commerce_pln)
    {
        return m_commerce_pln.j;
    }

    static void b(M_Commerce_PLN m_commerce_pln, String s)
    {
        m_commerce_pln.Y = s;
    }

    static void b(M_Commerce_PLN m_commerce_pln, ArrayList arraylist)
    {
        m_commerce_pln.U = arraylist;
    }

    static int c(M_Commerce_PLN m_commerce_pln)
    {
        return m_commerce_pln.W;
    }

    static void c(M_Commerce_PLN m_commerce_pln, String s)
    {
        m_commerce_pln.aa = s;
    }

    static void c(M_Commerce_PLN m_commerce_pln, ArrayList arraylist)
    {
        m_commerce_pln.T = arraylist;
    }

    static int d(M_Commerce_PLN m_commerce_pln)
    {
        return m_commerce_pln.f;
    }
    ...
    private void d()
    {
        ...
        do
        {
            ...
            ax ax1 = new ax(this, as2[0], as2[1], as2[2], as2[3], as2[4], as2[5], as2[6], as2[7]);
            if (as2[0] != null && as2[0].equals("PLN"))
            {
                j.add(ax1);
                i.add(ax1.a());
            }
    ...
    static void d(M_Commerce_PLN m_commerce_pln, String s)
    {
        m_commerce_pln.V = s;
    }

    static String e(M_Commerce_PLN m_commerce_pln)
    {
        return m_commerce_pln.X;
    }
    ...
    static void e(M_Commerce_PLN m_commerce_pln, String s)
    {
        m_commerce_pln.G = s;
    }

    static TextView f(M_Commerce_PLN m_commerce_pln)
    {
        return m_commerce_pln.ak;
    }

    static ArrayList g(M_Commerce_PLN m_commerce_pln)
    {
        return m_commerce_pln.n;
    }

    static ArrayList h(M_Commerce_PLN m_commerce_pln)
    {
        return m_commerce_pln.U;
    }

    static ArrayList i(M_Commerce_PLN m_commerce_pln)
    {
        return m_commerce_pln.T;
    }

    static EditText j(M_Commerce_PLN m_commerce_pln)
    {
        return m_commerce_pln.L;
    }
    ...
    protected final void a()
    {
        String s;
        int i1;
        i1 = Integer.parseInt(((ax)j.get(W)).b());
        f = 1;
        ...
        if (i1 == 6 && au.getText().toString().equals(""))
        {
            a(null, getString(0x7f0c0080).replace("#LABEL#", at.getText().toString()).replace(":", ""), getParent(), false, "Back");
            return;
        }
        if (i1 == 7)
        {
            if (ax.getText().toString().equals(""))
            {
                a(null, getString(0x7f0c0080).replace("#LABEL#", aw.getText().toString()).replace(":", ""), getParent(), false, "Back");
                return;
            }
...
_L6:
        ...
        continue; /* Loop/switch isn't completed */
_L7:
        s = (new StringBuilder(String.valueOf((new StringBuilder(String.valueOf((new StringBuilder(String.valueOf((new StringBuilder(String.valueOf(s))).append(au.getText().toString()).toString()))).append(":!:").toString()))).toString()))).append(":!:").toString();
...
_L10:
        ...
        if (obj instanceof HashMap)
        {
            ...
            if (k1 == 0)
            {
                obj = getString(0x7f0c0080).replace("#LABEL#", at.getText().toString()).replace(":", "");
            } else
            if (i1 == j1 && k1 != i1)
            {
                obj = getString(0x7f0c0081).replace("#SD.MIN#", (new StringBuilder()).append(i1).toString()).replace("#SD.MAX#", (new StringBuilder()).append(j1).toString()).replace("#LABEL#", at.getText().toString()).replace(":", "");
            } else
            if (k1 < i1 || k1 > j1)
            {
                obj = getString(0x7f0c0082).replace("#SD.MIN#", (new StringBuilder()).append(i1).toString()).replace("#SD.MAX#", (new StringBuilder()).append(j1).toString()).replace("#LABEL#", at.getText().toString()).replace(":", "");
            }
            if (!((String) (obj)).equals(""))
            {
                bn.a(((String) (obj)), getParent());
...
_L15:
        ...
        if (k1 == 0)
        {
            obj = getString(0x7f0c0080).replace("#LABEL#", aw.getText().toString()).replace(":", "");
        } else
        if (i1 == j1 && k1 != i1)
        {
            obj = getString(0x7f0c0081).replace("#SD.MIN#", (new StringBuilder()).append(i1).toString()).replace("#SD.MAX#", (new StringBuilder()).append(j1).toString()).replace("#LABEL#", aw.getText().toString()).replace(":", "");
        } else
        if (k1 < i1 || k1 > j1)
        {
            obj = getString(0x7f0c0082).replace("#SD.MIN#", (new StringBuilder()).append(i1).toString()).replace("#SD.MAX#", (new StringBuilder()).append(j1).toString()).replace("#LABEL#", aw.getText().toString()).replace(":", "");
        }
        if (!((String) (obj)).equals(""))
        {
            bn.a(((String) (obj)), getParent());
...
_L8:
        s1 = (new StringBuilder(String.valueOf((new StringBuilder(String.valueOf((new StringBuilder(String.valueOf((new StringBuilder(String.valueOf((new StringBuilder(String.valueOf((new StringBuilder(String.valueOf((new StringBuilder(String.valueOf((new StringBuilder(String.valueOf((new StringBuilder(String.valueOf((new StringBuilder(String.valueOf(s1))).append(ax.getText().toString()).toString()))).append(":!:").toString()))).toString()))).append(":!:").toString()))).toString()))).append(":!:").toString()))).toString()))).append(":!:").toString()))).append(aq.getText().toString()).toString()))).append(":!:").toString();
_L10:
...
_L6:
        s1 = (new StringBuilder(String.valueOf((new StringBuilder(String.valueOf((new StringBuilder(String.valueOf((new StringBuilder(String.valueOf(s1))).toString()))).append(":!:").toString()))).append(aa).toString()))).append(":!:").toString();
          goto _L1
_L7:
        s1 = (new StringBuilder(String.valueOf((new StringBuilder(String.valueOf((new StringBuilder(String.valueOf((new StringBuilder(String.valueOf(s1))).append(au.getText().toString()).toString()))).append(":!:").toString()))).append(I).toString()))).append(":!:").toString();
          goto _L1
_L9:
    ...
    {
        if (Integer.parseInt(((ax)j.get(W)).b()) == 6)
        {
            E = 3;
        } else
        {
    ...
    final void e(int i1)
    {
        ...
        as.setVisibility(8);
        av.setVisibility(8);
        String s1 = ((ax)j.get(i1)).a();
        String s = s1;
        if (s1.equals("PLN"))
        {
            s = getString(0x7f0c00a5);
        }
        ad.setText(s);
        ah.setText("");
        ak.setText("");
        ...
        ax.setText("");
        s = ((ax)j.get(i1)).b();
        ay = Integer.parseInt(s);
        String as1[] = ((ax)j.get(i1)).g();
        String as2[] = ((ax)j.get(i1)).h();
        if (Integer.parseInt(s) != 7)
        {
            ap.setText(getString(0x7f0c00a2));
            aq.setText((CharSequence)k.get(az));
        }
    ...
    public void onClick(View view)
    {
        ...
        if (af.equals(view))
        {
            int i1 = Integer.parseInt(((ax)j.get(W)).c());
            int j2 = Integer.parseInt(((ax)j.get(W)).d());
            com.d.b.a(getParent(), 4098, ag.getText().toString(), ah.getText().toString(), i1, j2, this);
            return;
        }
        if (ai.equals(view))
        {
            int j1 = Integer.parseInt(((ax)j.get(W)).e());
            int k2 = Integer.parseInt(((ax)j.get(W)).f());
            com.d.b.a(getParent(), 4099, aj.getText().toString(), ak.getText().toString(), j1, k2, this);
            return;
        }
        if (al.equals(view))
        {
            view = new ArrayList(Arrays.asList(((ax)j.get(W)).h()));
            com.d.b.a(getParent(), view, d);
            return;
        }
        if (ao.equals(view) && k.size() > 1)
        {
            if (ay == 7)
            {
                int k1 = Integer.parseInt(((ax)j.get(W)).c());
                int l2 = Integer.parseInt(((ax)j.get(W)).d());
        ...
        if (as.equals(view))
        {
            int l1 = Integer.parseInt(((ax)j.get(W)).c());
            int i3 = Integer.parseInt(((ax)j.get(W)).d());
            com.d.b.a(getParent(), 4102, at.getText().toString(), au.getText().toString(), l1, i3, this);
            return;
        }
        if (av.equals(view))
        {
            int i2 = Integer.parseInt(((ax)j.get(W)).c());
            int j3 = Integer.parseInt(((ax)j.get(W)).d());
            com.d.b.a(getParent(), 4105, aw.getText().toString(), ax.getText().toString(), i2, j3, this);
            return;
        } else
        {
            super.onClick(view);
    ...
    protected void onCreate(Bundle bundle)
    {
        ...
        ar = (ImageView)findViewById(0x7f0b0072);
        as = (RelativeLayout)findViewById(0x7f0b005f);
        at = (TextView)findViewById(0x7f0b0060);
        au = (TextView)findViewById(0x7f0b0061);
        av = (RelativeLayout)findViewById(0x7f0b0063);
        aw = (TextView)findViewById(0x7f0b0064);
        ax = (TextView)findViewById(0x7f0b0065);
        ...
        e(0);
        f(0);
        r.a(getApplicationContext(), "mbca_mcomm_pln_open", 40);
    }
...
_L1:
        ...
        s1 = aa;
        i1 = Integer.parseInt(((ax)j.get(W)).b());
        if (i1 != 1 && i1 != 6 || aA != 0) goto _L4; else goto _L3
_L3:
        String s = "";
...
_L6:
        ...
        int k1 = Integer.parseInt(((ax)j.get(W)).e());
        long l2 = Long.parseLong(((ax)j.get(W)).f());
        long l1;
        if (i1 == 6)
        {
